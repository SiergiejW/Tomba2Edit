...
Lifted out of gui/mdat/mdat_panel.py so the SMST view can have it too.
The two formats are the same packets reached different ways (see
gui/smst/smst_parser.py's header) and gui/polygon_pick.py already picks
...
both the MDAT and SMST viewers do, through gui/clut_animation.py - and a
