...
(the file has no Z - see formats/sprites/sprt_parser.py).
"""
import os
...
from psx.vram import VRAMError
from gui.widgets import panel_title
from gui.widgets.pixel_canvas import PixelCanvas, fit_zoom, zoom_label
from formats.sprites import sprt_edit
from formats.sprites.sprt_edit_panel import SpriteEditPanel
from formats.sprites.sprt_parser import SPRTError, load_sprt
from formats.sprites.sprt_render import (
...
# sprite's own index - see formats/models/smst_viewer.py's NAME_COLUMN/
...
class SPRTViewer(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Painting the selected piece - see formats/sprites/sprt_edit_panel.py.
    ...
    def load_sprt_data(self, dat_file_path, dat_start, offset, size,
        ...
        psx.vram_viewer.decode_vram_bytes) and is what the pieces are
