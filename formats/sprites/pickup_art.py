...
A pickup carries no art of its own. Its record (game/placement.py)
...
# 0x800 - the same two numbers game/placement.py reads.
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print(__doc__)
        print("usage: python -m formats.sprites.pickup_art <MAIN.EXE>")
        raise SystemExit(2)
