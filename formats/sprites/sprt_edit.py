...
formats/sprites/sprt_render.py, whose sampling this is the exact mirror of).
...
def shards_for(edited, rects):
    """[(x, y, w, h, pixels), ...] ready for formats/images/img_writer.py."""
    out = []
