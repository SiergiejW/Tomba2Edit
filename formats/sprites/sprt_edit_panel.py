...
become IMG shards and formats/images/img_writer.py appends them to the area's
...
from gui.widgets.pixel_canvas import PaintCanvas, fit_zoom
...
class SpriteEditPanel(QGroupBox):
    ...
    def _copy_clut_from_area(self):
        ...
        from formats.sprites.palette_dialog import PaletteImportDialog
