...
VOICE.XA interleaves 32 channels of spoken dialogue (see formats/audio/xa).
...
formats/text/voice_link.py). Guessing the boundaries from silence, as this
...
class VoicePanel(QWidget):
    ...
    def set_image(self, path):
        ...
        try:
            ...
            # on. See formats/audio/voice's own note on why.
