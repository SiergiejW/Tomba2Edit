...
The dialogue font is a grid in the font page (see formats/text/fontpage.py),
...
"""
from formats.text import tombadict
...
#              glyph out of it per character - see formats/text/biosfont.
...
#
# So a {code: character} table cannot describe it. formats/text/jptext is
...
# (see formats/text/fontpage.read_frame) - found the same way GLYPH_TOP
...
def derive(page, reference_page, reference_table, top=None, reference_top=40):
    ...
    from formats.text.fontpage import glyphs, find_glyph_top, glyph_row
