...
TOMBA2.IMG (see formats/text/fontpage.py). SLPS-02350 cannot: its page has
...
def extract(bios):
    ...
    fonts/psx-kanji.bin:
        ...
        python -m formats.text.biosfont SCPH5500.BIN
...
def _main(argv):
    if len(argv) != 2:
        print(__doc__)
        print("usage: python -m formats.text.biosfont <BIOS image>")
        return 2
