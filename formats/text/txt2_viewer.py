...
import formats.text.txt2 as txt2
from formats.text.txtd_viewer import (
    EntryTextHighlighter, EDITED_ENTRY_COLOR, EXPORTED_ENTRY_COLOR, ENTRY_LOCATION_ROLE,
)
from formats.text.txt2_packer import encode_text, TxtdPackError
...
class TXT2Viewer(QWidget):
    ...
    def on_tree_selection_changed(self):
        ...
        try:
            ...
            # See formats/text/txtd_viewer.py's own copy of this fix.
