...
themselves (see formats/text/fontpage.py for the layout).
...
# docstring of formats/text/fontpage.py uses.
def regions(glyph_top=fontpage.GLYPH_TOP):
    ...
    (see formats/text/dicts.GLYPH_TOP). Everything below the grid sits at a
...
SPRITES = (
    ...
    # row, the game's own numbers say so: formats/text/fontpage.py has held
...
class PageKind:
    ...
    def __init__(self, label, spec, sprites, cluts, default_clut, grid,
        ...
        self.spec = spec                # formats.text.fontpage.PageSpec
...
class _Detail(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # agree - see formats/text/translation.py, which owns the second
...
# The paintable canvas now lives in gui/widgets/pixel_canvas.py, so the
