...
The page holds two fonts on the same grid (see formats/text/fontpage.py):
...
formats/text/biosfont). Only the big text does. Its TXT2 is still the
...
from formats.text import biosfont
...
def cell_for(char):
    ...
    if dicts.japanese_disc():
        ...
        # ASCII 0x6F further along. See formats/text/jptext.cells().
