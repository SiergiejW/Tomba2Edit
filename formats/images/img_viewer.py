...
rectangular shards (see formats/images/img_codec.py).
...
from psx.vram_viewer import VRAMCanvas, decode_vram_bytes, vram_index_image
...
class IMGViewer(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # own art. See psx/vram_viewer.py's own copy of this pattern.
        ...
        self.textured_btn.setToolTip(
            ...
            "psx/vram_preview.py), not a guarantee.")
    ...
    def set_area_source(self, idx_path, dat_path, chunk_index):
        ...
        psx/vram_viewer.py's copy of this method."""
    ...
    def _textured_image(self):
        ...
        psx/vram_viewer.py's own copy of this, which this mirrors."""
