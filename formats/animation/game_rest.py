...
formats/animation/anmp_skeleton.py had to work out three things an animation frame
...
(formats/animation/skeleton_tree.py):
...
replaces: every rotation in formats/animation/tomba_rest.py is within 0.007 of
...
def joints(bones):
    ...
    [x, -y, z] formats/models/smst_parser applies to a vertex, and the
