...
formats/models/smst_parser.py) and nothing in an ANMP names a group. Both
answers are on the disc, in the 8-byte bone table the area's overlay or
MAIN.EXE carries - see formats/animation/skeleton_tree.py - but which table belongs
