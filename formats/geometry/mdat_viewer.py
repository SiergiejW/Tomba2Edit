...
class MDATViewer(ClutAnimationMixin, CameraEventMixin, QOpenGLWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Animated textures - see formats/animation/clut_animation.py.
    ...
    def _prepare_collision_buffers(self):
        ...
        editor's way - gui/widgets/collision_overlay.py. One SCLD covers more world
    ...
    def palette_texture(raw, transparent=False):
        ...
        formats/animation/clut_anim.py) and have to be turned into a texture the
    ...
    def prepare_buffers(self):
        ...
        try:
            ...
            # Which coplanar faces each one is drawn over - psx/draw_order.py.
    ...
    def initializeGL(self):
        ...
        if not self.shader_program.addShaderFromSourceCode(
                ...
                // that animate by UV - see formats/animation/uv_anim.py. Zero
                // for everything else.
                uniform vec2 uvOffset;
                // Faces drawn through a texture window - see
                // game/texture_window.py and SMSTViewer's shader.
                ...
                void main() {
                    if (useTextures) {
                        ...
                        // psx.vram.atlas_uv, one level down.
    ...
    def frame_level(self, heading=LEVEL_HEADING, pitch=LEVEL_PITCH):
        ...
        gui/widgets/camera_controls.py)."""
    ...
    def paintGL(self):
        ...
        if self.show_collision and self.collision.has_lines():
            ...
            # drawn again behind them, fainter - gui/widgets/collision_overlay.py.
