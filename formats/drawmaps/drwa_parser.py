...
follows his description, and formats/geometry/mdat.py reads the same bytes to
build the 3D room.
...
# record's own start. Straight out of formats/geometry/mdat.py - the fields are
    ...
    for count, stride, layout in ((tris, TRI_SIZE, TRI_VERTS),
        ...
        for _ in range(count):
            ...
            for ox, oy, oz in layout:
                ...
                # Y flipped, exactly as formats/geometry/mdat.py does it, so the
