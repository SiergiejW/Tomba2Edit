...
formats/executable/sop_editor.py - is currently understood well enough to edit;
...
from formats.executable.sop_viewer import SopViewer
from formats.text.txtd_viewer import EDITED_ENTRY_COLOR, EXPORTED_ENTRY_COLOR
