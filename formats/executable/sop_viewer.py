...
formats/executable/sop_editor.py for the scanning/packing logic this wraps).
...
from formats.executable.sop_editor import sop_entries, compute_pool_state, detect_build, UnsupportedSopError, SCREEN_CHAR_LIMIT
...
class SopViewer(QWidget):
    ...
    def __init__(self):
        ...
        # SOP BIN is drawn in the big font - see formats/text/font_preview.py.
