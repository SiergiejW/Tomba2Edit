"""
GUI viewer/editor for MAIN.EXE's string pool (see formats/executable/mainbin_parser.py
and formats/executable/mainbin_editor.py for the scanning/packing logic this wraps).
...
from formats.executable import mainbin_parser
...
class MainExeViewer(QWidget):
    ...
    def __init__(self):
        ...
        # MAIN.EXE is drawn in the small font - see formats/text/font_preview.py.
        ...
        # (see formats/executable/mainbin_parser) - which on the Japanese disc
