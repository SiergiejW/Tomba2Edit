...
# From the draw code at packet + 3, exactly as gui/smst/smst_parser.py
# and gui/mdat/mdat.py measure them.
...
def read_clut(data, at, kind):
    ...
    part of the address (see functions/psx_vram) - it is read past here
