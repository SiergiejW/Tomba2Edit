...
and palettes side by side (see psx/vram.py), and what a region
...
and lets the eye pick.
    ...
    textured    every patch this area's own MDAT room, SMST/SPRT/BGMP files are
                ...
                psx/vram_preview.py for what that can and can't
                know.
...
from psx.vram_preview import clut_spans, paint_cluts
...
def decode_vram_bytes(img_data):
    ...
    The shards and their instruction stream are formats/images/img_codec.py's
