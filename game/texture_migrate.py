...
See psx/vram_map.py for what counts as free, and why "free"
...
# The packet layout, the same numbers formats/models/smst_parser.py reads with.
...
def plan(blob, free, pages=None, clut_pages=None,
    ...
    `free` is the boolean halfword map from psx/vram_map. `pages`
